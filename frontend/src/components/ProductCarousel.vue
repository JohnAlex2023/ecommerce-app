      ...
      <SplideSlide v-for="producto in productos" :key="producto._id">
        <div class="card">
          ...
          <div class="cantidad-container">
            <button class="cantidad-btn" @click="cambiarCantidad(producto, -1)" :disabled="cantidades[producto._id] <= 1">-</button>
            <input type="number" v-model.number="cantidades[producto._id]" min="1" class="cantidad-input" />
  ...
  mounted() {
    axios.get('http://localhost:3000/api/productos')
      .then(res => {
        ...
        // Inicializa cantidades en 1 para cada producto
